...
(function (root) {
  ...
  var STRINGS = {
    ...
    kn: {
      ...
      "a11y.netlogHint": "ಸಂಪರ್ಕವಾಗುವಾಗ ಸ್ಥಾನಗಳ ಕೆಳಗೆ ಬರುವ ತಾಂತ್ರಿಕ ಪಟ್ಟಿ. ಸಂಪರ್ಕ ವಿಫಲವಾದಾಗ ಉಪಯುಕ್ತ, ಇಲ್ಲದಿದ್ದರೆ ಅನಗತ್ಯ.",
      ...
      "diag.path": "ಜಾಲ ಮಾರ್ಗ: {state}",
      "diag.closed": "ಸಂಪರ್ಕ ಮುಚ್ಚಿದೆ",
      "diag.error": "ಸಂಪರ್ಕ ದೋಷ: {type}",
      "diag.incoming": "ಯಾರೋ ಸಂಪರ್ಕಿಸುತ್ತಿದ್ದಾರೆ",
      "diag.signallingDropped": "ಸಂಜ್ಞೆ ತಪ್ಪಿತು — ಮತ್ತೆ ಸಂಪರ್ಕಿಸುತ್ತಿದೆ",
      "diag.retry": "ಉತ್ತರವಿಲ್ಲ — ಮತ್ತೊಮ್ಮೆ ಪ್ರಯತ್ನ",
      "diag.staleSession": "ಸಂಜ್ಞಾ ಸೇವೆ ಹಳೆಯ ಅವಧಿಯನ್ನೇ ಹಿಡಿದಿದೆ — ಮತ್ತೆ ಪ್ರಯತ್ನ",
      ...
      "howto.15": "ಮೊದಲ ಆಟಗಾರ ತನ್ನ ಎಲ್ಲಾ ಕಾಯಿಗಳನ್ನು ಮನೆಗೆ ತಲುಪಿಸಿದಾಗ, ಉಳಿದ ಸ್ಥಾನಗಳಿಗಾಗಿ ಆಟ ಮುಂದುವರಿಸಬೇಕೇ ಎಂದು ನೀವು ನಿರ್ಧರಿಸುತ್ತೀರಿ.",
    ...
    hi: {
      ...
      "a11y.netlogHint": "जुड़ते समय स्थानों के नीचे दिखने वाला तकनीकी विवरण। संपर्क विफल हो तो उपयोगी, वरना बेकार।",
      ...
      "howto.3": "हर चाल सीधी होती है, कभी तिरछी नहीं — एक अपवाद के साथ। 7×7 पट पर बाहरी घेरे से अगले घेरे में मुड़ना एक तिरछी चाल है, जो सीधे सुरक्षित कोने पर पड़ती है।",
      "howto.4": "मुँह ऊपर गिरी हर कौड़ी एक घर आगे ले जाती है — तीन ऊपर तो तीन घर।",
      "howto.5": "सभी ऊपर हों तो उतने ही घर — छोटे पट पर 4, बड़े पट पर 6 — और आप फिर फेंकते हैं।",
      "howto.6": "कोई भी ऊपर न हो तो दुगुना: छोटे पट पर 8, बड़े पट पर 12। इस पर भी आप फिर फेंकते हैं।",
      ...
      "howto.10": "सफ़ेद घेरे वाला हर घर सबके लिए सुरक्षित है। 5×5 पट पर ये केवल चार शुरुआती घर हैं; 7×7 पट पर बाहरी दो घेरों के कोने भी सुरक्षित हैं, पर केंद्र से पहले के अंतिम घेरे में कभी नहीं।",
