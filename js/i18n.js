...
(function (root) {
  ...
  var STRINGS = {
    ...
    en: {
      ...
      "setup.highContrast": "High contrast",
      "setup.highContrastSub": "stronger edges & shapes",
    ...
    kn: {
      ...
      "setup.display": "ಪ್ರದರ್ಶನ",
      "setup.standard": "ಸಾಮಾನ್ಯ",
      "setup.highContrast": "ಹೆಚ್ಚು ವ್ಯತ್ಯಾಸ",
      "setup.highContrastSub": "ದಪ್ಪ ಅಂಚು ಮತ್ತು ಆಕೃತಿಗಳು",
      "setup.language": "ಭಾಷೆ",
    ...
    hi: {
      ...
      "setup.display": "प्रदर्शन",
      "setup.standard": "सामान्य",
      "setup.highContrast": "उच्च कंट्रास्ट",
      "setup.highContrastSub": "गहरे किनारे और आकृतियाँ",
      "setup.language": "भाषा",
    ...
    es: {
      ...
      "setup.display": "Pantalla",
      "setup.standard": "Estándar",
      "setup.highContrast": "Alto contraste",
      "setup.highContrastSub": "bordes y formas marcados",
