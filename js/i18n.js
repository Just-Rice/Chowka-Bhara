...
(function (root) {
  ...
  var STRINGS = {
    ...
    en: {
      ...
      "howto.10": "Every square ringed in white is safe from capture, for everyone — the four starts, and the corners of every ring except the last one before home.",
    ...
    kn: {
      ...
      "howto.10": "ಬಿಳಿ ಗೆರೆಯಿರುವ ಪ್ರತಿ ಮನೆಯೂ ಎಲ್ಲರಿಗೂ ಸುರಕ್ಷಿತ — ನಾಲ್ಕು ಆರಂಭದ ಮನೆಗಳು, ಮತ್ತು ಮಧ್ಯದ ಹಿಂದಿನ ಕೊನೆಯ ಸುತ್ತನ್ನು ಬಿಟ್ಟು ಉಳಿದ ಪ್ರತಿ ಸುತ್ತಿನ ಮೂಲೆಗಳು.",
    ...
    hi: {
      ...
      "howto.10": "सफ़ेद घेरे वाला हर घर सबके लिए सुरक्षित है — चारों शुरुआती घर, और केंद्र से पहले के अंतिम घेरे को छोड़कर हर घेरे के कोने।",
    ...
    es: {
      ...
      "howto.10": "Toda casilla con borde blanco es segura para todos: las cuatro salidas y las esquinas de cada anillo salvo el último antes del centro.",
