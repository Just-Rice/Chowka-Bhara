...
(function (root) {
  ...
  var STRINGS = {
    ...
    en: {
      ...
      "howto.8": "Every square ringed in white is safe from capture, for everyone — the four starts, and the corners of the outer two rings.",
    ...
    kn: {
      ...
      "howto.8": "ಬಿಳಿ ಗೆರೆಯಿರುವ ಪ್ರತಿ ಮನೆಯೂ ಎಲ್ಲರಿಗೂ ಸುರಕ್ಷಿತ — ನಾಲ್ಕು ಆರಂಭದ ಮನೆಗಳು ಮತ್ತು ಹೊರಗಿನ ಎರಡು ಸುತ್ತುಗಳ ಮೂಲೆಗಳು.",
    ...
    hi: {
      ...
      "howto.8": "सफ़ेद घेरे वाला हर घर सबके लिए सुरक्षित है — चारों शुरुआती घर, और बाहरी दो घेरों के कोने।",
    ...
    es: {
      ...
      "howto.8": "Toda casilla con borde blanco es segura para todos: las cuatro salidas y las esquinas de los dos anillos exteriores.",
